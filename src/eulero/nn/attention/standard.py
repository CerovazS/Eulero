...
#TODO
# self.attn stored as instance state during forward - attention/standard.py
# Storing attention weights on self during forward() is problematic with multi-GPU 
# (DataParallel), gradient checkpointing, and concurrent inference. Should return 
# attention weights from the method instead.
